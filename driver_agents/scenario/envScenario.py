...
<<<<<<<< HEAD:driving_with_llm/scenario/envScenario.py

========
>>>>>>>> dl_develop:driver_agents/scenario/envScenario.py
...
<<<<<<<< HEAD:driving_with_llm/scenario/envScenario.py
        ...
        # The four variables below are used to determine 
        # whether a vehicle is within the dangerous sight 
        # distance of the ego vehicle
